"""GLFTv3 - Advanced GLFT Microstructure Strategy Engine.

V3 Enhancements:
- 24 novel microstructure factors (10 v1 + 6 v2 + 8 v3)
...
- Target Sharpe > 3.5
- Target MaxDD < -5%
- Sharpe-optimized volatility targeting
"""
...
class GLFTv3Strategy(StrategyBase):
    """GLFTv3 - Advanced Market Microstructure Strategy."""
    ...
    def config(self) -> StrategyConfig:
        ...
        return StrategyConfig(
            name="glft_v3",
            display_name="GLFTv3 (Advanced Microstructure)",
            version="3.0",
            min_date=cfg.MIN_DATE,
            exchanges=list(cfg.EXCHANGES),
            factors=GLFT_V3_FACTORS,
            topn=cfg.TOPN_BASE,
            max_pos=cfg.MAX_POS,
            min_pos=cfg.MIN_POS,
            ...
            tc_bps=cfg.TC_BPS,
            description=(
                "Advanced GLFT microstructure strategy with 40 factors. "
                "MTF-OFI, regime toxicity, market flow, execution quality. "
                "Sharpe-optimized: 12 long / 8 short, low DD target."
            ),
    ...
    def run(
        ...
        *,
        ...
        if xr is None:
            raise ImportError("xarray required for GLFTv3 strategy")
        ...
        # 2) Compute factors with all v3 params
        ...
        self._factors = {nm: F.sel(factor=nm) for nm in GLFT_V3_FACTORS if nm in F.factor.values}
        ...
        # 5) Portfolio construction - Sharpe-optimized
        portfolio_params = PortfolioParams(
            ...
            long_seats=cfg.LONG_SEATS,
            short_seats=cfg.SHORT_SEATS,
            fixed_long_frac=0.60,  # Balanced long-short
        ...
        if write_outputs:
            ...
            meta = {
                ...
                "model": "GLFTv3 Advanced Microstructure",
                "factors": {
                    "total": len(GLFT_V3_FACTORS),
                    "novel": len(GLFT_V3_NOVEL_FACTORS),
                    "complementary": len(GLFT_V3_COMPLEMENTARY_FACTORS),
                    "novel_list": GLFT_V3_NOVEL_FACTORS,
                    "all": GLFT_V3_FACTORS,
                },
                "risk_profile": {
                    "target_sharpe": ">3.5",
