#!/usr/bin/env python
"""Ingest NDX market data from Quantiacs into PostgreSQL database.

This script fetches NDX (NASDAQ 100) historical market data from Quantiacs
and stores it in a local PostgreSQL database.

Usage:
    python scripts/ingest_ndx.py --start-date 2015-01-01 --end-date 2025-01-24
    python scripts/ingest_ndx.py --start-date 2015-01-01 --end-date 2025-01-24 --force-refresh
"""
...
from q23.database.ingestion import ingest_ndx_data
...
def main():
    parser = argparse.ArgumentParser(
        description="Ingest NDX market data from Quantiacs into PostgreSQL"
    )
    parser.add_argument(
        "--start-date",
        type=str,
